...
void ErrCalc(TH1F *HIST,int binxn,double perc,double & X_val, double & errXL,double & errXH){
  ...
  */
  ...
  //  if(h1->GetEntries() == 0 ) goto endd;                                                                                                                   //cout<<" " <<arsize<<endl;                                                                                
...
void Ex_pho(){
  ...
  // TFile *f1 = new TFile("/nfs_scratch/sacharya/monophoton/CMSSW_10_6_20/src/PhotonIDs/merged/ALLPV/Isopt/CutTMVABarrel90_HPT.root");  
  //   TFile *f1 = new TFile("/nfs_scratch/sacharya/UL_studies/CMSSW_10_6_20/src/Photon_ID_2018/Isopt/CutTMVABarrelUL1to30.root");   
  //  TFile  *f1 =  new TFile ("CutTMVABarrelUL1_60.root");
  //  TFile  *f1 =  new TFile ("../CutTMVABarrelUL1_60_ALLpv.root");
  TFile  *f1 =  new TFile ("CutTMVAEndCapUL1_60_Truepv.root");
  // TFile  *f1 =  new TFile ("/nfs_scratch/sacharya/UL_studies/CMSSW_10_6_20/src/Photon_ID/egamma_id/Isopt/CutTMVABarrelTrainner5_30.root"); 
...
float genPt,ppt,peta,Sie_ie,iso_P,iso_C,iso_N,to_e,weighT;
  ...
  TH2F *isoPptS = new TH2F("isoPptS","ECAL isolation vs Pt",100,0,1000,1000,0,100);
  ...
  //  TF1 *fn1 = new TF1("fn1","[0]*x + [1]",200,1000);
  /*  TF1 *fn1 = new TF1("fn1","[0]*x + [1]",200,1000);
  ...
  */
  ...
  IsoptScaling->GetYaxis()->SetTitle("Photon Isolation Correction ");
  IsoptScaling->GetYaxis()->SetRangeUser(0,20);
  c3->cd(2); 
  his2->Draw("colz");
  his2->GetXaxis()->SetTitle("Pt GeVc^{-1}");
  his2->GetYaxis()->SetTitle("Photon Isolation Correction. ");
  //  his2->GetYaxis()->SetRangeUser(0,100);
  c3->SaveAs("Straightline_end_.png");
  c3->SaveAs("Straightline_end_.C");
  //lets fit this graph
